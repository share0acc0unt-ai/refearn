            ...
            <div className="layout-container flex h-full grow flex-col">
                <div className="px-4 md:px-10 lg:px-20 xl:px-40 flex flex-1 justify-center py-5">
                    <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
                        {/* TopNavBar */}
                        <header className="relative flex items-center justify-between whitespace-nowrap border-b border-solid border-foreground/10 px-4 md:px-10 py-3 bg-background">
                                    ...
                                    {formData.targetedReach && (
                                        <div className="flex flex-col gap-2 p-4 bg-[#102215] border border-[#32673f] rounded-lg">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="text-white text-lg font-bold">{bill.toLocaleString()} credits</span>
                                            </div>
